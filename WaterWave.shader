    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float sinValue = sin(_Frequency * _Time.y - v.vertex.z * _InvWaveLength);
                float cosValue = cos(_Frequency * _Time.y - v.vertex.z * _InvWaveLength - 1.0);
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed3 specular = _LightColor0.rgb * pow(abs(dot(bump, halfDir)), _Gloss) * _SpecularScale;
