    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float4 offsetWave = (0.0, 0.0, 0.0, 0.0);
                ...
                offsetWave.y = sin(_Frequency * _Time.y - v.vertex.z * _InvWaveLength) * _Magnitude * (7/(v.vertex.z+7));
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                //fixed3 finalColor = reflCol * fresnel + zhesColor * (1 - fresnel);
